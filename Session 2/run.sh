...
# python extract-features.py ../data/test/ > test.feat
...
# python predict.py test.feat model.crf > test-CRF.out
# # evaluate CRF results
# echo "Evaluating CRF results..."
# python ../util/evaluator.py NER ../data/devel devel-CRF.out > devel-CRF.stats
# python ../util/evaluator.py NER ../data/test test-CRF.out > test-CRF.stats
...
# python predict.py test.feat model.lrg > test-LR.out
# # evaluate LR results
# echo "Evaluating LR results..."
# python ../util/evaluator.py NER ../data/devel devel-LR.out > devel-LR.stats
# python ../util/evaluator.py NER ../data/test test-LR.out > test-LR.stats
...
# python ../util/evaluator.py NER ../data/test test-SVM.out > test-SVM.stats
...
# python predict.py test.feat model.rft > test-RF.out
# evaluate RF results
# echo "Evaluating RF results..."
# python ../util/evaluator.py NER ../data/devel devel-RF.out > devel-RF.stats
# python ../util/evaluator.py NER ../data/test test-RF.out > test-RF.stats
...
python predict.py test.feat model.abc > test-AB.out
...
python ../util/evaluator.py NER ../data/test test-AB.out > test-AB.stats
