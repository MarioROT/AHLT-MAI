...
# python predict.py train.feat model.mem > train-MEM.out
...
# python $AHLT/util/evaluator.py DDI $AHLT/data/ MEM.out DDI-ML-MEM > MEM.stats
...
python $AHLT/util/evaluator.py DDI $AHLT/data/ SVM.out DDI-ML-SVM > SVM.stats
...
# python predict.py train.feat model.abc > train-ABC.out
# python predict.py devel.feat model.abc > devel-ABC.out
# python predict.py test.feat model.abc > test-ABC.out
# # # evaluate AB results
# echo "Evaluating AB results..."
# # python $AHLT/util/evaluator.py DDI $AHLT/data/devel devel-AB.out > devel-AB.stats
# python $AHLT/util/evaluator.py DDI $AHLT/data/ ABC.out DDI-ML-ABC > ABC.stats
